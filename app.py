# -*- coding: utf-8 -*-
"""
Created on Fri May 12 16:28:16 2023
...
# Generar gráfica
fig = px.line(df2, x='yearmonth', y='disparos', color = 'boro', width=1300, height=600)
st.plotly_chart(fig)
...
df2['perp_age_group'] = df2['perp_age_group'].replace({'940':'N/A',
                              '224':'N/A','1020':'N/A', '(null)':'N/A','UNKNOWN':'N/A', '1028' :'N/A'})
...
fig.update_layout(xaxis_title="<b>Cant Atacante<b>",
                  yaxis_title="<b>Rango Edades<b>", template = 'simple_white',
                  paper_bgcolor='rgba(0,0,0,0)',
                  plot_bgcolor='rgba(0,0,0,0)')
...
df2['vic_age_group'] = df2['vic_age_group'].replace({'940':'N/A',
                              '224':'N/A','1020':'N/A', '(null)':'N/A','UNKNOWN':'N/A', '1028' :'N/A', '1022' :'N/A'})
